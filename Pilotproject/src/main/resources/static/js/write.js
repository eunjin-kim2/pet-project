...
function check(){
    ...
    let o_passwd2 = owner.o_passwd2;
    let o_name = owner.o_name;
    ...
    if(o_passwd.value != o_passwd2.value){
    ...
    if(!expO_name.test(o_name.value)){
        alert("이름을 한글, 영문자로 입력해주세요!");
        o_name.focus();
        o_name.value="";
        return false;
    }
