...
<div class="content">
	...
	<div class="btn-area">
		<a href="/owner/ownermain" class="btn"><input type="button" value=" 이전 페이지"></a>
		<a href="/owner/passwordCheckForm?mode=update"><input type="button" value="회원정보수정" class="update-btn"></a>
	</div>
